...
const SiteList = () => {
  return (
    ...
    <div className='w-[30%] h-full p-4 flex flex-col items-center justify-center'>
      ...
      <h1 className=' font-bold my-3'>250 Sites</h1>
      <button className=" text-sm border-0 outline-0 bg-[#009B00] text-white font-bold flex items-center gap-2"> <AddOutlinedIcon className= ' text-white font-bold text-sm'/>Add New Site </button>
    </div>
    
    <div className='w-[70%] h-full p-4 overflow-y-scroll mb-3'>
      <h1 className='font-bold my-3 sticky z-20'>List of all Sites</h1>
