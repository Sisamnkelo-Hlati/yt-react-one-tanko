...
const posts = () => {
  return (
    <div className=' py-2 px-3'>
      ...
      <div className='bg-white shadow-xl rounded-xl py-5 px-12'>
        ...
        <h1 className='my-4 font-bold '>Lorem, ipsum dolor sit amet consectetur adipisicing elit.</h1>
                ...
                <div className='flex items-start gap-3  px-1 py-2 w-full my-2'>
                    ...
                    <div className="w-full">
                        ...
                        <div className='flex items-center gap-3 mt-2'>
                            <ThumbUpOutlinedIcon className= 'mr-2 text-[10px] text-gray-500'/>
                            <InsertCommentOutlinedIcon className= 'mr-2 text-[10px] text-gray-500'/>
