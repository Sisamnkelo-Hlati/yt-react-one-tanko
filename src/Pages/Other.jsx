                        ...
                        <div className='h-[calc(100vh-56px)] bg-gray-50 flex'>
                            ...
                            <div className=' w-full p-3 bg-gray-50 rounded-xl' >
                              <div className='py-2 flex items-center justify-between mb-5'>
                                <h1 className='text-xl text-[#009B00] font-bold'>List of All Other Participants</h1>
                                <button className='bg-[#009B00] px-4 py-2 font-bold text-white'>Add New Participant</button>
                              </div>
                                <DataTable/>
